	...
	private void initialize() {
		...
		{  
		    ...
		    {  
		       ...
		       PaginaRegistre paginaRegistre = new PaginaRegistre();
		       String[] s = new String[] {"0"};
		...
		JLabel bgCosPagina;
		bgCosPagina = new JLabel("",new ImageIcon(MenuPpal.class.getResource("/imatgesPerPantalles/imatgesApp/podcastsBG_Neon.jpg")),SwingConstants.CENTER);
